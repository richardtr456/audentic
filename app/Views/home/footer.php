<footer>
        <div class="datos">
            <div class="info">
                ...
                <hr>
                <p>Somos un equipo humano que busca a través de la Odontología entregar un servicio que nos
                    apasiona. Estamos convencidos que estamos conectados con las emociones de nuestros
            ...
            <div class="info">
                <h4>Links rápidos</h4>
                <hr>
                <p>Licencia <br><br> Soporte <br><br> FAQ <br><br> Terminos y Condiciones</p>
            </div>
            <div class="info">
        ...
        <div class="container1">
            <div class="derecho">Copyright © 2022 Audentic. Todos los derechos reservados</div>
        </div>
    </footer>
</body>
