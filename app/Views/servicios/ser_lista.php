						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Lista de Servicios</div>
								</div>
								<div class="card-body">
									<div class="row">
										<div class="col-md-12">
										...
										<table  class="display table table-striped table-hover" id="users-list">
											...
											<tbody>
												...
												<tr>
													<td><?php echo $user-> id_servicio; ?></td>
													<td><?php echo $user-> nombre_servicio; ?></td>
													...
													<a href="#delete_<?php echo $user->id_servicio; ?>" class="btn btn-danger btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span> Borrar</a>
                                                    
                                                    <!-- MODAL ELIMINAR -->
													<div class="modal fade" id="delete_<?php echo $user->id_servicio ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-body">	
																	...
																	<h2 class="text-center"><?php echo $user-> nombre_servicio; ?></h2>
																</div>
																<div class="modal-footer">
																	<button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancelar</button>
																	<a href="<?php echo base_url('/menu/servicios/eliminar/'.$user->id_servicio);?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span>Borrar</a>
																</div>

															</div>
														</div>
													</div>
													<!-- <a href="<?php echo base_url('/menu/servicios/eliminar/'.$user->id_servicio);?>" class="btn btn-danger btn-sm">Eliminar</a> -->
													</td>
												</tr>
												<?php endforeach; ?>
												<?php endif; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="add_create" action="<?php echo base_url('menu/servicios/registrar')?>" method="POST" autocomplete="off">
...
<div class="modal fade" id="editar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!--Formulario de registro de nuevo paciente -->
                <form action="<?php echo base_url('menu/servicios/actualizar')?>" method="POST" >
                    <input type="hidden" name="id_servicio" id="update_id">
                     <div class="form-group">
                            <label>Servicio</label>
